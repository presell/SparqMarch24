...
import sty from "./PlasmicBlog1.module.css"; // plasmic-import: 8-BommJzSoLw/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicBlog1.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicBlog1.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
        ...
        <meta
          key="description"
          name="description"
          content={PlasmicBlog1.pageMetadata.description}
        />
        <meta
          key="og:description"
              ...
              >
                ...
                {(
                  ...
                  >
                    ...
                    <div
                      className={classNames(projectcss.all, sty.columns__jbeKd)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                      ...
                      <div
                        className={classNames(projectcss.all, sty.column__iLsm)}
                      >
                        <_1440VarietyRedo
